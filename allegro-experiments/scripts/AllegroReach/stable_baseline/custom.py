...
import numpy as np
from gym import spacesnal as F
from stable_baselines3.commo
from torch.nn import function.on_policy_algorithm import OnPolicyAlgorithm
...
class CustomActorCriticPolicy(ActorCriticPolicy):
    ...
    def extract_features(self, obs: th.Tensor) -> th.Tensor:
        ...
        preprocessed_obs = preprocess_obs(obs['observation'], self.observation_space, normalize_images=self.normalize_images)
    
        obs_concat = th.cat((obs['desired_goal'],obs['observation']),1)
        th.reshape(obs_concat,(13,))
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            with th.no_grad():
                ...
                print("The value of self._last_obs")
                print(self._last_obs)
                obs_tensor = obs_as_tensor(self._last_obs, self.device)
                print("The value of obs_tensor")
                print(obs_tensor)
